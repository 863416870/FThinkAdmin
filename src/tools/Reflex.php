...
use library\reflex\Analysis;
use library\reflex\Check;
...
class Reflex
{
    ...
    public function check($object){
        ...
        Check::checkPHPEnv();
        Check::checkParamIsObject($object);
    }
    /**
     * 设置类
     * @param $object
    ...
    public function setObject($object){
        try {
            ...
            $this->analyse = new Analysis($this->rc->getDocComment());
    ...
    public final function setMethod(string $method): self
    {
        try {
            ...
            $this->analyse = new Analysis($this->rm->getDocComment());
            return $this;
        } catch (\Exception $exception) {
